                        ...
                        <View style={styles.container}>
                            {description &&
                                <View style={styles.part}>
                                    <Text style={styles.text}>Généaka est une entreprise spécialisé dans la création des arbres généalogiques.</Text>
                                    <Text style={styles.text}>Ils avaient besoin d'un site web pour présenter les types d'abres et pour avoir la possibilité aux clients de demander un devis.</Text>
                                </View>
                            }
                            {technicalPart &&
                                <View style={styles.part}>
                                    <Text style={styles.text}>Pour la création du site internet Généaka, j'ai utilisé React.js, j'ai l'habitude de coder à l'aide de VS CODE et d'utiliser Git.</Text>
